...
Locally, `python3 -m http.server` and open `http://127.0.0.1:8000/` —
...
just send to. That's what `sync.gs` is: a small Google Apps Script
...
`https://<user>.github.io/directory-tool/`. Nothing else to configure.
